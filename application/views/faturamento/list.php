                ...
                foreach ($dados->result() as $row) {
                    ...
                    echo '<td class="text-center">
                        <div class="btn-group">
                            ...
                            <a style="color:#000; font-family:arial;" href="' . base_url() . 'faturamento/create/' . $row->id . '" data-toggle="tooltip" title="Visualizar Cliente" class="btn btn btn-default"><i style=" color:#000; " class="fa fa-plus"> </i> Novo</a>

                            <a href="' . base_url() . 'faturamento/detalhe/' . $row->id . '" data-toggle="tooltip" title="Detalhe Cliente" class="btn btn btn-primary"><i style=" color:#fff; " class="fa fa-eye"> </i> Detalhes</a>
